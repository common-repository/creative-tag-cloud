...
if ( ! class_exists('ChattyMango_CreativeTagCloud_Feed') ) {

  class ChattyMango_CreativeTagCloud_Feed {
    ...
    /**
    * instantiation of DOMDocument and ChattyMango_CreativeTagCloud_Cache
    *
    * @param void
    * @return void
    */
    public function __construct() {
      ...
      if ( class_exists( 'ChattyMango_CreativeTagCloud_Cache' ) ) {
        $this->cache = new ChattyMango_CreativeTagCloud_Cache();
        $this->cache
        ->type( ChattyMango_CreativeTagCloud_Cache::WP_OPTIONS )
