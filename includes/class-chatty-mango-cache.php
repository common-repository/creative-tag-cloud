...
if ( ! class_exists('ChattyMango_CreativeTagCloud_Cache') ) {
  ...
  class ChattyMango_CreativeTagCloud_Cache {

    const VERSION = "1.3.0"; // Chatty Mango Cache
    ...
    private $path; // absolute path where to store cache files, if $type == ChattyMango_CreativeTagCloud_Cache::FILE
    ...
    */
    static function init() {
      ...
      $instance = new ChattyMango_CreativeTagCloud_Cache();
    ...
    * @return object $this
    */
    public function type( $type = ChattyMango_CreativeTagCloud_Cache::WP_OPTIONS ) {

      // check if dpendencies are met
      if ( ChattyMango_CreativeTagCloud_Cache::WP_OPTIONS == $type && ! function_exists( 'get_option' ) ) {
    ...
    */
    public function get() {
      ...
      switch ( $this->type ) {
        ...
        case ChattyMango_CreativeTagCloud_Cache::WP_OPTIONS:
        ...
        case ChattyMango_CreativeTagCloud_Cache::FILE:
        ...
        case ChattyMango_CreativeTagCloud_Cache::OTHER:
    ...
    */
    ...
    ##############################
    #         ChattyMango_CreativeTagCloud_Cache::WP_OPTIONS
    ##############################

    /**
    * Getter for use with native ChattyMango_CreativeTagCloud_Cache::WP_OPTIONS - simple but maybe not useful for big amounts of data
    *
    * @param void
    * @return mixed
    */
    ...
    /**
    * Setter for use with native ChattyMango_CreativeTagCloud_Cache::WP_OPTIONS - simple but maybe not useful for big amounts of data
    *
    * @param mixed $data
    * @return bool success?
    */
    ...
    */
    ...
    ##############################
    #         ChattyMango_CreativeTagCloud_Cache::FILE
    #
    # file pattern: key as md5, dash, timestamp, dot, php
    ##############################

    /**
    * Getter for use with ChattyMango_CreativeTagCloud_Cache::FILE
    *
    * @param void
    * @return mixed
    */
    ...
    /**
    * Getter for use with ChattyMango_CreativeTagCloud_Cache::FILE - simple but maybe not useful for big amounts of data
    *
    * @param mixed $data
    * @return bool success?
    */
